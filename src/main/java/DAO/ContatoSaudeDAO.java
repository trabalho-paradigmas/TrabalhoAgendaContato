...
public class ContatoSaudeDAO {
    ...
    public List<ContatoSaudeDTO> read() throws SQLException {
        String sql = "SELECT cf.id, c.nome, c.email, c.celular,  cf.telefone_comercial, cf.especializacao FROM contato_saude cf "
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                String telefone_comercial = resultSet.getString("telefone_comercial");
                 String especializacao = resultSet.getString("especialização");
                

               ContatoSaudeDTO contato = new ContatoSaudeDTO(id, nome, celular, email, telefone_comercial, especializacao);
    ...
    return contatos;
     ...
     public List<ContatoSaudeDTO> pesquisar(String filtro) throws SQLException {
    String sql = "SELECT cf.id, c.nome, c.email, c.celular, cf.telefone_cormecial, cf.especializacao FROM contato_saude cf " +
                 "JOIN contato c ON c.id = cf.id_contato " +
  ...
  public void delete(int idContato) {
        Connection conn = null;
        PreparedStatement statementContatoSaude = null;
        ...
        try {
            ...
            statementContatoSaude = conn.prepareStatement("DELETE FROM contato_saude WHERE id = ?");
            statementContatoSaude.setInt(1, idContato);
            statementContatoSaude.executeUpdate();
